...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "top.metass.api";
    private static final String ARTIFACT_ID = "metass";
    private static final String PACKAGE_NAME = "top.metass.pro";
    private static final String TITLE = "三生宇宙管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "top.metass.api";
        String artifactIdNew = "metass";
        String packageNameNew = "top.metass.pro";
        String titleNew = "三生宇宙管理系统";
