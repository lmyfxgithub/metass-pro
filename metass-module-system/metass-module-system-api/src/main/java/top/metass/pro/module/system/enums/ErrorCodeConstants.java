package top.metass.pro.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 站内信发送 1002028000 ==========
    ErrorCode NOTIFY_SEND_TEMPLATE_PARAM_MISS = new ErrorCode(1002027000, "模板参数({})缺失");


    // ========== 会员模块 1002013000 ==========
    ErrorCode MEMBER_USER_GPT_NOT_EXISTS = new ErrorCode(1002013000, "用户账号不存在");
    ErrorCode MEMBER_USER_GPT_HIS_NOT_EXISTS = new ErrorCode(1002013001, "用户账号不存在");
    ErrorCode MEMBER_USER_GPT_INSUFFICIENT_INTEGRAL = new ErrorCode(1002013003, "账户余额不足");
    ErrorCode MEMBER_SPU_NOT_EXISTS = new ErrorCode(1002013004, "会员商品不存在");
