...
import top.metass.pro.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
...
import top.metass.pro.module.system.dal.mysql.permission.MenuMapper;
import top.metass.pro.module.system.enums.permission.MenuTypeEnum;
import top.metass.pro.module.system.mq.producer.permission.MenuProducer;
...
import static top.metass.pro.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("三生").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
