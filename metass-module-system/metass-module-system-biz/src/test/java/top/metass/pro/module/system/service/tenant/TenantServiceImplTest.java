package top.metass.pro.module.system.service.tenant;

import top.metass.pro.framework.common.enums.CommonStatusEnum;
import top.metass.pro.framework.common.pojo.PageResult;
import top.metass.pro.framework.tenant.config.TenantProperties;
import top.metass.pro.framework.tenant.core.context.TenantContextHolder;
import top.metass.pro.framework.test.core.ut.BaseDbUnitTest;
import top.metass.pro.module.system.controller.admin.tenant.vo.tenant.TenantCreateReqVO;
import top.metass.pro.module.system.controller.admin.tenant.vo.tenant.TenantExportReqVO;
import top.metass.pro.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
...
import top.metass.pro.module.system.dal.dataobject.permission.RoleDO;
...
import top.metass.pro.module.system.dal.mysql.tenant.TenantMapper;
import top.metass.pro.module.system.enums.permission.RoleCodeEnum;
import top.metass.pro.module.system.enums.permission.RoleTypeEnum;
...
import top.metass.pro.module.system.service.tenant.handler.TenantInfoHandler;
import top.metass.pro.module.system.service.tenant.handler.TenantMenuHandler;
...
import static top.metass.pro.framework.common.util.collection.SetUtils.asSet;
import static top.metass.pro.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static top.metass.pro.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static top.metass.pro.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static top.metass.pro.framework.test.core.util.AssertUtils.assertPojoEquals;
import static top.metass.pro.framework.test.core.util.AssertUtils.assertServiceException;
import static top.metass.pro.framework.test.core.util.RandomUtils.*;
import static top.metass.pro.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static top.metass.pro.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("三生", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("三生"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("三生");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
