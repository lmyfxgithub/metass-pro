package top.metass.pro.module.system.service.user;
...
import top.metass.pro.framework.common.util.collection.ArrayUtils;
...
import top.metass.pro.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import top.metass.pro.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import top.metass.pro.module.system.controller.admin.user.vo.user.*;
import top.metass.pro.module.system.dal.dataobject.dept.DeptDO;
import top.metass.pro.module.system.dal.dataobject.dept.PostDO;
import top.metass.pro.module.system.dal.dataobject.dept.UserPostDO;
...
import top.metass.pro.module.system.dal.mysql.dept.UserPostMapper;
import top.metass.pro.module.system.dal.mysql.user.AdminUserMapper;
import top.metass.pro.module.system.enums.common.SexEnum;
import top.metass.pro.module.system.service.dept.DeptService;
import top.metass.pro.module.system.service.dept.PostService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("metassyuanma");
        ...
        assertEquals("metassyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("metassyuanma"))).thenReturn("java");
