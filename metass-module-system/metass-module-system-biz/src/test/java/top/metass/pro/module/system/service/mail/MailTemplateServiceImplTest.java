package top.metass.pro.module.system.service.mail;
...
import top.metass.pro.module.system.controller.admin.mail.vo.template.MailTemplateCreateReqVO;
import top.metass.pro.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import top.metass.pro.module.system.controller.admin.mail.vo.template.MailTemplateUpdateReqVO;
import top.metass.pro.module.system.dal.dataobject.mail.MailTemplateDO;
import top.metass.pro.module.system.dal.mysql.mail.MailTemplateMapper;
import top.metass.pro.module.system.mq.producer.mail.MailProducer;
...
import static top.metass.pro.framework.test.core.util.RandomUtils.randomLongId;
import static top.metass.pro.framework.test.core.util.RandomUtils.randomPojo;
import static top.metass.pro.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
       ...
       // 测试 name 不匹配
       mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("三生")));
       // 测试 code 不匹配
