...
import top.metass.pro.framework.common.util.validation.ValidationUtils;
...
import top.metass.pro.module.system.convert.auth.AuthConvert;
...
import top.metass.pro.module.system.enums.oauth2.OAuth2ClientConstants;
...
public class AdminAuthServiceImpl implements AdminAuthService {
     ...
     * 验证码的开关，默认为 true
     */
    @Value("${metass.captcha.enable:true}")
