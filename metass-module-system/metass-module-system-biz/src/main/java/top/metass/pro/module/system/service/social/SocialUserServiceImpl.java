...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 MetassAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private MetassAuthRequestFactory metassAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = metassAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
