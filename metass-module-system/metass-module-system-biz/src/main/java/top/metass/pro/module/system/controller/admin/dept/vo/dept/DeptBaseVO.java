package top.metass.pro.module.system.controller.admin.dept.vo.dept;
...
public class DeptBaseVO {
    ...
    @Schema(description = "菜单名称", required = true, example = "三生")
    ...
    @Schema(description = "邮箱", example = "metass@iocoder.cn")
