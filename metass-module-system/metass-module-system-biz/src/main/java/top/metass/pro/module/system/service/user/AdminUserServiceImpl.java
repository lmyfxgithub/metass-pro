...
import top.metass.pro.framework.datapermission.core.util.DataPermissionUtils;
...
import top.metass.pro.module.system.convert.user.UserConvert;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:metassyuanma}")
