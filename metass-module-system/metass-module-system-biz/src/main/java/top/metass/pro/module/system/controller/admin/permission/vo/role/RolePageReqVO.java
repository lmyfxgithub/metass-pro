package top.metass.pro.module.system.controller.admin.permission.vo.role;
...
public class RolePageReqVO extends PageParam {
    ...
    @Schema(description = "角色名称,模糊匹配", example = "三生")
    private String name;

    @Schema(description = "角色标识,模糊匹配", example = "metass")
    private String code;
