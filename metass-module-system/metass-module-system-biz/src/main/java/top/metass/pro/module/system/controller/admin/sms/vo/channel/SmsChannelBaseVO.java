package top.metass.pro.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelBaseVO {
    ...
    @Schema(description = "短信签名", required = true, example = "三生宇宙")
    ...
    @Schema(description = "短信 API 的账号", required = true, example = "metass")
