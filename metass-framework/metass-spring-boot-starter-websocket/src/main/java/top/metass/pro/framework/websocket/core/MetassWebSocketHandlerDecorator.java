package top.metass.pro.framework.websocket.core;
...
public class MetassWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public MetassWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
