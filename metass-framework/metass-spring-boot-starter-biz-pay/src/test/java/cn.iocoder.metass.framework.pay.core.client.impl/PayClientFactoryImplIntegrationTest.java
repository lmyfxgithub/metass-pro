package top.metass.pro.framework.pay.core.client.impl;
...
import top.metass.pro.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import top.metass.pro.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import top.metass.pro.framework.pay.core.client.impl.wx.WXPayClientConfig;
import top.metass.pro.framework.pay.core.client.impl.wx.WXPubPayClient;
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_ALIPAY_QR() {
        ...
        // 发起支付
        PayOrderUnifiedReqDTO reqDTO = buildPayOrderUnifiedReqDTO();
        reqDTO.setNotifyUrl("https://api.metass.top/admin-api/pay/notify/callback/18"); // TODO @tina: 这里改成你的 natapp 回调地址
