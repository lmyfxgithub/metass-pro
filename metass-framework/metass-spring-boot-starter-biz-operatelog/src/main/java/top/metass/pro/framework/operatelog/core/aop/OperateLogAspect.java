package top.metass.pro.framework.operatelog.core.aop;
...
import top.metass.pro.framework.common.util.monitor.TracerUtils;
import top.metass.pro.framework.common.util.servlet.ServletUtils;
import top.metass.pro.framework.operatelog.core.enums.OperateTypeEnum;
import top.metass.pro.framework.operatelog.core.service.OperateLog;
import top.metass.pro.framework.operatelog.core.service.OperateLogFrameworkService;
import top.metass.pro.framework.web.core.util.WebFrameworkUtils;
...
import static top.metass.pro.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        top.metass.pro.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                top.metass.pro.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         top.metass.pro.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           top.metass.pro.framework.operatelog.core.annotations.OperateLog operateLog,
