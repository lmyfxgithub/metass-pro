package top.metass.pro.ssodemo.client;

import top.metass.pro.ssodemo.client.dto.CommonResult;
import top.metass.pro.ssodemo.client.dto.user.UserInfoRespDTO;
import top.metass.pro.ssodemo.client.dto.user.UserUpdateReqDTO;
