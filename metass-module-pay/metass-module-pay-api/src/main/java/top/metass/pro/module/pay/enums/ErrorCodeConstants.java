package top.metass.pro.module.pay.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode PAY_MEMBER_SPU_NOT_FOUND = new ErrorCode(1007002000, "支付商品信息不存在");
    ...
    ErrorCode PAY_ORDER_ERROR = new ErrorCode(1007003004, "支付异常");
