package top.metass.pro.module.pay.controller.admin.merchant;

import top.metass.pro.module.pay.controller.admin.merchant.vo.merchant.*;
...
public class PayMerchantController {
    ...
    @Parameter(name = "name", description = "商户名称", example = "三生")
    @PreAuthorize("@ss.hasPermission('pay:merchant:query')")
