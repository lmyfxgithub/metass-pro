...
import top.metass.pro.module.pay.convert.channel.PayChannelConvert;
...
import static top.metass.pro.module.pay.enums.ErrorCodeConstants.CHANNEL_EXIST_SAME_CHANNEL_ERROR;
...
public class PayChannelServiceImpl implements PayChannelService {
    ...
    private void settingConfigAndCheckParam(PayChannelDO channel, String configStr) {
        ...
        // TODO @三生：不要使用 hutool 的 json 工具，用项目的
