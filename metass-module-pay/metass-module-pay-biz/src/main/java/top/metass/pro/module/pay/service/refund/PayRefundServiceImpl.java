package top.metass.pro.module.pay.service.refund;

import cn.hutool.core.util.RandomUtil;
import cn.hutool.core.util.StrUtil;
import top.metass.pro.framework.common.exception.util.ServiceExceptionUtil;
...
import top.metass.pro.framework.pay.core.client.dto.notify.PayRefundNotifyRespDTO;
import top.metass.pro.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import top.metass.pro.framework.pay.core.enums.PayNotifyRefundStatusEnum;
...
import top.metass.pro.module.pay.dal.mysql.refund.PayRefundMapper;
...
import top.metass.pro.module.pay.enums.refund.PayRefundTypeEnum;
...
public class PayRefundServiceImpl implements PayRefundService {
    ...
    public Long createPayRefund(PayRefundCreateReqDTO reqDTO) {
        ...
        if(Objects.nonNull(payRefundDO)){
            ...
            payRefundDO = PayRefundDO.builder()
                    ...
                    .orderId(order.getId())
                    .merchantRefundNo(merchantRefundId) // TODO 三生：需要优化
        ...
        unifiedReqDTO.setUserIp(reqDTO.getUserIp())
                ...
                .setMerchantRefundId(merchantRefundId)  // TODO 三生：需要优化
                .setNotifyUrl(genChannelPayNotifyUrl(channel)) // TODO 三生：优化下 notifyUrl
    ...
    public void notifyPayRefund(Long channelId, PayRefundNotifyRespDTO notify, PayNotifyReqDTO rawNotify) {
        ...
        if (Objects.equals(PayNotifyRefundStatusEnum.SUCCESS, notify.getStatus())){
            ...
            // TODO @jason：那这里可以考虑打个 error logger @三生 微信是否存在支付异常通知
        }
    }
