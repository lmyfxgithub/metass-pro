...
import top.metass.pro.module.pay.service.merchant.PayAppServiceImpl;
import top.metass.pro.module.pay.service.merchant.PayChannelServiceImpl;
import top.metass.pro.module.pay.service.order.dto.PayOrderCreateReqDTO;
import top.metass.pro.module.pay.service.order.dto.PayOrderSubmitReqDTO;
import top.metass.pro.module.pay.test.BaseDbIntegrationTest;
import top.metass.pro.framework.common.util.date.DateUtils;
import top.metass.pro.framework.pay.config.MetassPayAutoConfiguration;
...
@Import({PayOrderServiceImpl.class, PayAppServiceImpl.class,
        PayChannelServiceImpl.class, MetassPayAutoConfiguration.class})
