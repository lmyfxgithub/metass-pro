...
import top.metass.pro.module.bpm.convert.definition.BpmFormConvert;
...
import top.metass.pro.module.bpm.enums.ErrorCodeConstants;
import top.metass.pro.module.bpm.enums.definition.BpmModelFormTypeEnum;
import top.metass.pro.module.bpm.service.definition.dto.BpmFormFieldRespDTO;
import top.metass.pro.module.bpm.service.definition.dto.BpmModelMetaInfoRespDTO;
...
public class BpmFormServiceImpl implements BpmFormService {
    ...
    private void checkFields(List<String> fields) {
        if (true) { // TODO 三生：兼容 Vue3 工作流：因为采用了新的表单设计器，所以暂时不校验
            return;
        }
