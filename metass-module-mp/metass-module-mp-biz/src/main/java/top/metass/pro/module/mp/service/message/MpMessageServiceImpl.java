package top.metass.pro.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.StrUtil;
import top.metass.pro.framework.common.pojo.PageResult;
import top.metass.pro.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import top.metass.pro.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import top.metass.pro.module.mp.convert.message.MpMessageConvert;
...
import top.metass.pro.module.mp.dal.dataobject.user.MpUserDO;
import top.metass.pro.module.mp.dal.mysql.message.MpMessageMapper;
import top.metass.pro.module.mp.enums.message.MpMessageSendFromEnum;
import top.metass.pro.module.mp.framework.mp.core.MpServiceFactory;
import top.metass.pro.module.mp.framework.mp.core.util.MpUtils;
import top.metass.pro.module.mp.service.account.MpAccountService;
import top.metass.pro.module.mp.service.material.MpMaterialService;
import top.metass.pro.module.mp.service.message.bo.MpMessageSendOutReqBO;
import top.metass.pro.module.mp.service.user.MpUserService;
...
import static top.metass.pro.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
