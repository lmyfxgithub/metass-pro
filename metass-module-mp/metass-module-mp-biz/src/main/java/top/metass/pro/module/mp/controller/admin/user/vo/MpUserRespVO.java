package top.metass.pro.module.mp.controller.admin.user.vo;
...
public class MpUserRespVO  {
    ...
    @Schema(description = "公众号粉丝标识", required = true, example = "")
    ...
    @Schema(description = "昵称", example = "三生")
    ...
    @Schema(description = "公众号账号的 appId", required = true, example = "wxbc1536ffdb7c8da4")
