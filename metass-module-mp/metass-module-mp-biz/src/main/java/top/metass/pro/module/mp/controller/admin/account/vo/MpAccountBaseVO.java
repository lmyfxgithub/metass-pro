package top.metass.pro.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号名称", required = true, example = "三生宇宙")
    @NotEmpty(message = "公众号名称不能为空")
    private String name;

    @Schema(description = "公众号微信号", required = true, example = "metassyuanma")
    ...
    @Schema(description = "备注", example = "请关注三生宇宙，学习技术")
