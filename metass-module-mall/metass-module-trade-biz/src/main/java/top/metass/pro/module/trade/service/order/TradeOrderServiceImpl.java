...
import top.metass.pro.module.trade.controller.app.order.vo.AppTradeOrderCreateReqVO.Item;
...
import top.metass.pro.module.trade.enums.ErrorCodeConstants;
...
import static top.metass.pro.framework.common.util.collection.CollectionUtils.*;
import static top.metass.pro.module.pay.enums.ErrorCodeConstants.PAY_ORDER_NOT_FOUND;
import static top.metass.pro.module.trade.enums.ErrorCodeConstants.*;
...
public class TradeOrderServiceImpl implements TradeOrderService {
    ...
    public void receiveOrder(Long userId, Long id) {
        ...
        // TODO 三生：lili 发送订单变化的消息

        // TODO 三生：lili 发送商品被购买完成的数据
    }
    ...
    public void updateOrderItemAfterSaleStatus(Long id, Integer oldAfterSaleStatus, Integer newAfterSaleStatus, Integer refundPrice) {
        ...
        // TODO 三生：未来如果有分佣，需要更新相关分佣订单为已失效
    }
