package top.metass.pro.module.trade.service.order;

import top.metass.pro.framework.common.enums.CommonStatusEnum;
import top.metass.pro.framework.common.enums.TerminalEnum;
import top.metass.pro.framework.test.core.ut.BaseDbUnitTest;
import top.metass.pro.module.member.api.address.AddressApi;
...
import top.metass.pro.module.pay.api.order.PayOrderApi;
...
import top.metass.pro.module.product.api.sku.ProductSkuApi;
import top.metass.pro.module.product.api.sku.dto.ProductSkuRespDTO;
import top.metass.pro.module.product.api.spu.ProductSpuApi;
...
import top.metass.pro.module.promotion.api.coupon.CouponApi;
import top.metass.pro.module.promotion.api.price.PriceApi;
...
import top.metass.pro.module.trade.dal.mysql.order.TradeOrderItemMapper;
import top.metass.pro.module.trade.dal.mysql.order.TradeOrderMapper;
import top.metass.pro.module.trade.enums.order.*;
import top.metass.pro.module.trade.framework.order.config.TradeOrderConfig;
...
public class TradeOrderServiceTest extends BaseDbUnitTest {
    ...
    public void testCreateTradeOrder_success() {
        ...
        // mock 方法（用户收件地址的校验）
        AddressRespDTO addressRespDTO = new AddressRespDTO().setId(10L).setUserId(userId).setName("三生")
        ...
        assertEquals(tradeOrderDO.getReceiverName(), "三生");
