...
import top.metass.pro.module.promotion.convert.price.PriceConvert;
...
import top.metass.pro.module.promotion.enums.common.*;
import top.metass.pro.module.promotion.enums.coupon.CouponStatusEnum;
import top.metass.pro.module.promotion.service.coupon.CouponService;
import top.metass.pro.module.promotion.service.discount.DiscountActivityService;
import top.metass.pro.module.promotion.service.discount.bo.DiscountProductDetailBO;
import top.metass.pro.module.promotion.service.reward.RewardActivityService;
...
import static top.metass.pro.framework.common.util.collection.CollectionUtils.getSumValue;
import static top.metass.pro.module.product.enums.ErrorCodeConstants.SKU_NOT_EXISTS;
...
//                            .setMeetTip(String.format("差 %s 元可用优惠劵", formatPrice(coupon.getUsePrice() - originPrice)));
     ...
     * 计算商品级别的价格，例如说：
     * 1. 会员折扣
     * 2. 限时折扣 {@link top.metass.pro.module.promotion.dal.dataobject.discount.DiscountActivityDO}
     *
     * 其中，会员折扣、限时折扣取最低价
     *
     * @param userId 用户编号
    ...
    /**
     * 计算订单级别的价格，例如说：
     * 1. 满减送 {@link top.metass.pro.module.promotion.dal.dataobject.reward.RewardActivityDO}
     *
     * @param userId 用户编号
     * @param priceCalculate 价格计算的结果
     */
    ...
    private void addPromotion(PriceCalculateRespDTO priceCalculate, PriceCalculateRespDTO.OrderItem orderItem,
        ...
        // 创建营销明细 Item
        // TODO 三生：orderItem.getPayPrice() 要不要改成 orderDividePrice；同时，newPayPrice 要不要改成直接传递 discountPrice
