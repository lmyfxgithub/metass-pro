...
import top.metass.pro.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, MetassRedisAutoConfiguration.class})
