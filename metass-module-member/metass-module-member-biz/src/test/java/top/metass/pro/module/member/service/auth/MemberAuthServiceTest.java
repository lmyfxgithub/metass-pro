package top.metass.pro.module.member.service.auth;
...
import top.metass.pro.module.member.controller.app.auth.vo.AppAuthResetPasswordReqVO;
import top.metass.pro.module.member.controller.app.auth.vo.AppAuthUpdatePasswordReqVO;
...
import top.metass.pro.module.system.api.logger.LoginLogApi;
...
// TODO @三生：单测的 review，等逻辑都达成一致后
/**
 * {@link MemberAuthService} 的单元测试类
 *
 * @author 宋天
 */
@Import({MemberAuthServiceImpl.class, MetassRedisAutoConfiguration.class})
