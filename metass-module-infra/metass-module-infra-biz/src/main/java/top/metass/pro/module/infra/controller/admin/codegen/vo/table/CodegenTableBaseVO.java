package top.metass.pro.module.infra.controller.admin.codegen.vo.table;
...
public class CodegenTableBaseVO {
    ...
    @Schema(description = "表名称", required = true, example = "metass")
    @NotNull(message = "表名称不能为空")
    private String tableName;

    @Schema(description = "表描述", required = true, example = "三生")
    ...
    @Schema(description = "作者", required = true, example = "三生宇宙")
