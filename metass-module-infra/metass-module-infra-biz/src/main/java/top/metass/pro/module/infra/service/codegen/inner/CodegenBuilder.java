...
import top.metass.pro.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import top.metass.pro.module.infra.enums.codegen.CodegenColumnListConditionEnum;
import top.metass.pro.module.infra.enums.codegen.CodegenTemplateTypeEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link top.metass.pro.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getJavaField(), "name")) {
            column.setExample(randomEle(new String[]{"张三", "李四", "王五", "赵六", "三生"}));
            return;
        }
        // status
