package top.metass.pro.module.infra.controller.admin.logger.vo.apierrorlog;
...
import top.metass.pro.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(top.metass.pro.module.system.enums.DictTypeConstants.USER_TYPE)
