package top.metass.pro.module.infra.service.codegen.inner;
...
import top.metass.pro.module.infra.enums.codegen.CodegenSceneEnum;
import top.metass.pro.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "metass-module-${table.moduleName}/" + // 顶级模块
                "metass-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "metass-module-${table.moduleName}/" + // 顶级模块
                "metass-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "metass-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "metass-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
}
