package top.metass.pro.module.infra.service.file;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import top.metass.pro.framework.common.pojo.PageResult;
import top.metass.pro.framework.file.core.client.FileClient;
import top.metass.pro.framework.file.core.client.FileClientConfig;
import top.metass.pro.framework.file.core.client.FileClientFactory;
import top.metass.pro.framework.file.core.client.local.LocalFileClient;
import top.metass.pro.framework.file.core.client.local.LocalFileClientConfig;
import top.metass.pro.framework.file.core.enums.FileStorageEnum;
...
import top.metass.pro.module.infra.dal.mysql.file.FileConfigMapper;
import top.metass.pro.module.infra.mq.producer.file.FileConfigProducer;
import lombok.Data;
...
import static top.metass.pro.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static top.metass.pro.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
       // mock 数据
       FileConfigDO dbFileConfig = randomFileConfigDO().setName("三生宇宙")
